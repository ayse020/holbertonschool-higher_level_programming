...
This project contains solutions for the "Python - More Data Structures" tasks from Holberton School. The tasks focus on working with sets and dictionaries in Python.
